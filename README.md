...
Can you modify the breadth-first search in such a way that it will allow you to traverse both nested objects and nested arrays (or even — gasp! — a mix of both)?
